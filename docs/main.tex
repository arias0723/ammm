...
\addplot[fill=green, thick] table[col sep=comma, x expr=0, y=mean_time] {data/s100_p1000_greedy/s100_p1000_instance_0.csv};
\addplot[fill=yellow, thick] table[col sep=comma, x expr=0, y=mean_time] {data/s100_p1000_grasp/s100_p1000_instance_0.csv};
\addplot[fill=blue, thick] table[col sep=comma, x expr=0, y=mean_time] {data/s100_p1000_greedy_ls/s100_p1000_instance_0.csv};
\addplot[fill=red, thick] table[col sep=comma, x expr=0, y=mean_time] {data/s100_p1000_grasp_ls/s100_p1000_instance_0.csv};
\addplot[fill=brown, thick] table[col sep=comma, x expr=0, y=mean_time] {data/s100_p1000_cplex/s100_p1000_instance_0.csv};
