...
\subsubsection{Pseudocode (Local Search)}
\begin{algorithm}[H]
    ...
    \While{time $<$ endTime \textbf{and} iter $<$ maxIterations}
        ...
        \If{neighborhoodStrategy == 'Both'}
            ...
            \If{neighbor.getFitness() < incumbentCost}
                \State incumbent $\gets$ neighbor; incumbentCost $\gets$ neighbor.getFitness();
            \EndIf
        ...
        \Else
            ...
            \EndIf
        \EndIf
        \State \textbf{break} \Comment{FIX...local optimum reached}
    \EndWhile
