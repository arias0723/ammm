...
We decided to select Karger's algorithm with only one run per greedy exploration because sometimes the min-cut can be unfeasible while another cut with larger cost can give a feasible output.
\\[0.5cm]
