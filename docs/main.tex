...
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_0.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_1.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_2.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_3.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_4.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_5.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_6.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_7.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_8.csv};
\addplot table[x=alpha, y expr=\thisrow{mean_objective} + \thisrow{std_objective}, col sep=comma] {grasp_s100_p1000_tuning/s100_p1000_instance_9.csv};

\legend{dataset=s100\_p1000\_instance\_0,dataset=s100\_p1000\_instance\_1,dataset=s100\_p1000\_instance\_2,dataset=s100\_p1000\_instance\_3,dataset=s100\_p1000\_instance\_4,dataset=s100\_p1000\_instance\_5,dataset=s100\_p1000\_instance\_6,dataset=s100\_p1000\_instance\_7,dataset=s100\_p1000\_instance\_8,dataset=s100\_p1000\_instance\_9}
...
\addplot [fill=blue] table [
    ...
    x=alpha,
    y=mean_time
] {grasp_s100_p1000/s100_p1000_results.csv};
\addlegendentry{GRASP w/o Local Search}

\end{axis}
\end{tikzpicture}
\captionsetup{labelformat=empty}
\caption{Figure 4.2: Solving Time for GRASP without Local Search across $\alpha$}
\label{fig:fig42}
\end{figure}
